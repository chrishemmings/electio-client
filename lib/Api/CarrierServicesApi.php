...
/**
 * CarrierServicesApi Class Doc Comment
 *
 * @category Class
 * @package  ChrisHemmings\ElectioClient
 * @author   http://github.com/swagger-api/swagger-codegen
...
class CarrierServicesApi
{
    ...
    /**
     * Operation getAvailableCarrierServices
     *
     * 
     *
     ...
     */
    public function getAvailableCarrierServices($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getAvailableCarrierServicesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }

    /**
     * Operation getAvailableCarrierServicesWithHttpInfo
     *
     * 
     *
     * @param string $subscriptionKey subscription key in url (optional)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getAvailableCarrierServicesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/carrierservices/carrierservices";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation getAvailableMPDCarrierServices
     *
     * 
     *
     * @param string $subscriptionKey subscription key in url (optional)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getAvailableMPDCarrierServices($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getAvailableMPDCarrierServicesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }

    /**
     * Operation getAvailableMPDCarrierServicesWithHttpInfo
     *
     * 
     *
     * @param string $subscriptionKey subscription key in url (optional)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getAvailableMPDCarrierServicesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/carrierservices/";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
