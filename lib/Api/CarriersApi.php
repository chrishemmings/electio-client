...
class CarriersApi
{
     ...
     */
    public function getCarrierServices($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getCarrierServicesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }

    /**
     * Operation getCarrierServicesWithHttpInfo
     *
     * 
     *
     * @param string $subscriptionKey subscription key in url (optional)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCarrierServicesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCarriers($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getCarriersWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCarriersWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
