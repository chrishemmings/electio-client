...
class StaticDataApi
{
     ...
     */
    public function getCountries($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getCountriesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCountriesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/staticdata/countries";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCurrencies($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getCurrenciesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getCurrenciesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/staticdata/currencies";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getPermissions($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getPermissionsWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getPermissionsWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/staticdata/permissions";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getTimezones($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getTimezonesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getTimezonesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/staticdata/timezones";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getTitles($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getTitlesWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getTitlesWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/staticdata/titles";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
