...
class ShippingLocationsApi
{
    ...
    /**
     * Operation getAssignedShippingLocations
     *
     * 
     *
     ...
     */
    public function getAssignedShippingLocations($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getAssignedShippingLocationsWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }

    /**
     * Operation getAssignedShippingLocationsWithHttpInfo
     *
     * 
     *
     * @param string $subscriptionKey subscription key in url (optional)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getAssignedShippingLocationsWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/shippingLocations/assigned";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getShippingLocations($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getShippingLocationsWithHttpInfo($subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getShippingLocationsWithHttpInfo($subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // parse inputs
        $resourcePath = "/shippingLocations/";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
