...
class DocumentsApi
{
    ...
    /**
     * Operation getLabelsForConsignment
     *
     * 
     *
     ...
     */
    public function getLabelsForConsignment($consignmentReference, $subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        list($response) = $this->getLabelsForConsignmentWithHttpInfo($consignmentReference, $subscriptionKey, $ocpApimSubscriptionKey);
        return $response;
    }

    /**
     * Operation getLabelsForConsignmentWithHttpInfo
     *
     * 
     *
     * @param string $consignmentReference  (required)
     ...
     * @throws \ChrisHemmings\ElectioClient\ApiException on non-2xx response
     */
    public function getLabelsForConsignmentWithHttpInfo($consignmentReference, $subscriptionKey = null, $ocpApimSubscriptionKey = null)
    {
        // verify the required parameter 'consignmentReference' is set
        if ($consignmentReference === null) {
            throw new \InvalidArgumentException('Missing the required parameter $consignmentReference when calling getLabelsForConsignment');
        }
        // parse inputs
